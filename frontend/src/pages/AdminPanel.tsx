      ...
      <div className="px-4 mt-4">
        ...
        {loading && (
          <div className="flex justify-center py-10">
            <div className="flex gap-2">
              {[0, 150, 300].map((d) => (
                <span key={d} className="w-2 h-2 rounded-full bg-cyber-purple animate-bounce" style={{ animationDelay: `${d}ms` }} />
              ))}
            </div>
          </div>
        )}
        ...
        {!loading && tab === 'stats' && stats && (
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <StatCard label="Foydalanuvchilar" value={stats.total_users} color="text-cyber-purple" />
        ...
        {!loading && tab === 'orders' && (
          <div className="space-y-3">
            ...
            {orders.map((order) => (
              <div key={order.id} className="bg-[#1a1a2e] border border-white/10 rounded-2xl p-4">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className={`text-[10px] font-bold px-2 py-1 rounded-lg border flex-shrink-0 ${statusColor(order.status)}`}>
