  ...
  return (
    <div className="min-h-screen bg-cyber-bg pb-24">
      ...
      <div className="relative">
        ...
        {/* Header banner */}
        <div className="h-32 bg-gradient-to-br from-purple-900 via-indigo-900 to-cyber-bg rounded-b-3xl flex items-end p-5">
          <div>
            <h1 className="text-2xl font-bold text-white">PUBG MOBILE</h1>
            <p className="text-sm text-gray-300 mt-1">🎮 UC & Propuski</p>
          </div>
        </div>
      </div>
