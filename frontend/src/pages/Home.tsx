          ...
          <div className="grid grid-cols-2 gap-4">
            {games.map((g) => (
              <div
                ...
                className="relative bg-cyber-card border border-cyber-border rounded-none p-4 cursor-pointer hover:border-[#FF6B00] transition-all flex flex-col justify-between h-[155px] animate-fade-in group select-none"
              >
                {g.popular && (
